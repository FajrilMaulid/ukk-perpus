        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form action="{{ route('petugas.buku.search') }}" method="GET" class="input-group input-group-sm" style="width: 150px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('petugas.buku.destroy', $item->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
