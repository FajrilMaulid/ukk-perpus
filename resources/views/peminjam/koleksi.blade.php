                        ...
                        <div class="card shadow-small">
                            <div class="card-body">
                                <div style="height: 385px; overflow: hidden;">
                                    <img class="card-img-top p-3" style="object-fit: cover; width: 100%;" src="{{ asset('storage/buku/' . $item->buku->sampul) }}" alt="{{ $item->buku->judul }}" />
                                </div>
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                    <button class="btn btn-outline-dark btn-lg" data-bs-toggle="modal" data-bs-target="#ModalBuku_{{ $item->id }}" type="button">
                                        <i class="bi bi-book-half"></i>
                                        Detail
                                    </button>
                                    <span class="ms-auto text-warning fw-bold d-block text-center rate">★{{ number_format($item->buku->ulasan->avg('rating'), 1) }}/5</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" >
                                            <img src="{{ asset('storage/buku/' . $item->buku->sampul) }}" class="img-thumbnail w-100 mb-3" style="margin-left: -15px">
                                            <span class="ms-auto text-warning fw-bold d-block text-center rate"><span class="text-dark">Rate: </span>★{{ number_format($item->buku->ulasan->avg('rating'), 1) }}/5</span>
                                        </div>
                                    </div>
                                    ...
                                    @else
                                        ...
                                        <p class="card-text"><strong>Tanggal Peminjaman:</strong> {{ date('d-m-Y', strtotime($item->peminjaman->tanggal_peminjaman)) }}</p>
                                        <p class="card-text"><strong>Tanggal Pengembalian:</strong> {{ date('d-m-Y', strtotime($item->peminjaman->tanggal_pengembalian)) }}</p>
                                        <button class="btn btn-outline-dark flex-shrink-0 btn-lg" type="button" data-bs-dismiss="modal">
                                            <i class="bi bi-book-half"></i>
                                            Tutup
                                        </button>
                                    @endif
